public class Pancakes {
    public static void main(String[] args) {
        ...
        // pancakes = new StringNode("chocolate", pancakes); 
        // adding a chocolate pancake to the top
        // pancakes = new StringNode("blueberry", pancakes); 
        // adding a blueberry pancake to the top
        // pancakes = new StringNode("red velvet", pancakes);
        // adding a red velvet pancake to the top
